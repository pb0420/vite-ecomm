...
const StripePaymentPage = ({ customerDetails, deliveryDetails }) => {
  ...
  const [stripePromise, setStripePromise] = useState(() => loadStripe("pk_test_L1f0e3XAzjsG7jtp4uN7L9ql");
  ...
  return (
   <div>
     ...
     { stripeCS && (<Elements options={{clientSecret:"pi_3RTjnRA3GELNlHOQ07mt3ZZi_secret_J7JMiaJG1wpQInHf7w6giRN8D"}} stripe={stripePromise} >  
       <StripeCheckoutForm />
    </Elements>) }
    </div>
  )
